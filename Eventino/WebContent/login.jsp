...
<div id="header"></div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Username" name="Usernamename">
                        </div>
                        <div class="input-group">
    ...
    <footer class="py-5 bg-black">
      <div class="container">
        <p class="m-0 text-center text-white small">Copyright &copy; Eventino 2018</p>
      </div>
      <!-- /.container -->
    </footer>

    <!-- Jquery JS-->
    <script src="reg_log_vendor/jquery/jquery.min.js"></script>
    <!-- Vendor JS-->
    <script src="reg_log_vendor/select2/select2.min.js"></script>
    <script src="reg_log_vendor/datepicker/moment.min.js"></script>
    <script src="reg_log_vendor/datepicker/daterangepicker.js"></script>
